package com.yang.common.tools.queue.bootstrap;
...
import com.yang.common.tools.queue.Slot;
    ...
    final class SlotTask implements Runnable {
		...
		public void run() {
            ...
            while (it.hasNext()) {
            	...
            	LOG.info("running_current_solt:currentSecond={}, task={}, taskQueueSize={}", currentSecond, task.toString(), tasks.size());
